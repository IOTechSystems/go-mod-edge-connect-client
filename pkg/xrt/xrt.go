...
func NewDiscoveryOptions(discoveryTopic string, discoveryMessageHandler topicmgr.MessageHandler, discoveryDuration, discoveryTimeout time.Duration) *DiscoveryOptions {
...
func NewDiscoveryOptionsExtended(discoveryTopic string, discoveryMessageHandler topicmgr.MessageHandler, discoveryDuration, discoveryTimeout time.Duration, extendedDiscoveryOptions map[string]any) *DiscoveryOptions {
